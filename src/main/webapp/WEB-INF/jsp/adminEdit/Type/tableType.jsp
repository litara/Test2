...
<script src="js/admin-type.js" defer></script>
</head>
<body>
	<div class="container">
		<div class="container"><form action="search-admin-type" method="post" name="form" onsubmit="return false;">
		...
		<table class="table table-dark margin-form-control-5">
			...
			<tbody id="tbody">
				<c:forEach items="${tableType}" var="i">

					<tr>
						<td>${i.getName()}</td>
						<td>
						<form method="POST" action="admin-type-del">
