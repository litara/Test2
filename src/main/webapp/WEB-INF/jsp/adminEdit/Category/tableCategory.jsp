...
<body>
	<div class="container">
		<div class="container"><form action="search-admin-category" method="post" name="form" onsubmit="return false;">
		...
		<table class="table table-dark margin-form-control-5">
			...
			<tbody id="tbody">
				<c:forEach items="${tableCategory}" var="i">

					<tr>
						<td>${i.getName()}</td>
						<td>
						<form method="POST" action="admin-category-del">
